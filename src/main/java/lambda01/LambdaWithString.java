...
public class LambdaWithString {
    public static void main(String[] args) {
        ...
        System.out.println("getRemainingEl(list) = " + getRemainingEl(list));
        System.out.println(list);
        System.out.println();
        sortLenghtUpper(list);
        System.out.println();
        System.out.println("checkLength(list) = " + checkLength(list));
    }
    /*
...
public static List<String> getRemainingEl(List<String> list){
    list.removeIf(t->t.length()<5);       // change the list permanently
    return list;
}
/*
Use “Functional Programming”
 ...
 */
    public static void sortLenghtUpper(List<String> list){
        list.
                stream().
...
public  static boolean checkLength(List<String> list){
	...
	*/
    ...
    public static void sortLastChar(List<String> list){
        list.stream().map(String::toLowerCase).sorted(Comparator.comparing(t->t.substring(t.length()-1))).forEach(System.out::println);
    }
    /*
	Use "Functional Programming"
	...
	*/
    ...
    public static void getCharAndLength(List<String> list){
        list.stream().sorted(Comparator.comparing(String::length)).map(t->t + ": " + t.length()).forEach(System.out::println);
    }
    /*
	Use "Functional Programming"
